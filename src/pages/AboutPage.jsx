        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-6 md:grid-cols-[1.1fr_1fr] md:items-center">
          ...
          <article className="bg-white p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700">
              Whisky casks provide investors with tangible asset ownership, benefiting from increasing rarity and a proven history of strong long-term demand. As the spirit matures, each cask typically becomes rarer and more valuable, enhancing its desirability over time.
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700">
